...
function MyRecipesList({ userRecipes, setUserRecipes }) {
    ...
    const handleDeleteRecipe = (recipeId) => {
        // Performs the delete operation and update the state of userRecipes in the MyRecipes.jsx
        // Once the state of userRecipes is updated in MyRecipes, it is passed as prop into here again to be rendered.
