...
function MyRecipeEditing() {
    ...
    const fetchRecipeDetailsForEditing = async () => {
        try {
            ...
            // If response.ok the fetched details are used to set the initial state values for editing.
            if (response.ok) {
    ...
    const handleSaveChanges = async () => {
        try {
            ...
            if (response.ok) {
                ...
                // user is redirected back to MyRecipeDetails.
                // The useEffect in MyRecipeDetails is triggered again due to the change in params.id, 
                // fetching and displaying the updated recipe details.
